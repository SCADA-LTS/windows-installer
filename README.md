...
## 1.1 Java - [start page](https://github.com/SCADA-LTS/windows-installer/blob/master/README.md#table-of-contents)
...
## 1.2. Server MySQL - [start page](https://github.com/SCADA-LTS/windows-installer/blob/master/README.md#table-of-contents)
...
## 1.3. Client MySQL - Dbeaver - [start page](https://github.com/SCADA-LTS/windows-installer/blob/master/README.md#table-of-contents)
...
## 2. Run installer - [start page](https://github.com/SCADA-LTS/windows-installer/blob/master/README.md#table-of-contents)
...
## 3. Config Tomcat after running the installer - [start page](https://github.com/SCADA-LTS/windows-installer/blob/master/README.md#table-of-contents)
1. Tomcat stopped;
